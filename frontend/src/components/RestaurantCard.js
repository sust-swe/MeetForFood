...
export default class RestaurantCard extends Component{
    ...
    render(){
        return (
            <Card className="profile-dashboard " style={{ alignItems: "left",paddingTop: "0px" }}>
        <Image
          ...
          rounded
        />
        <Card.Body style={{ justifyContent: "space-evenly",backgroundColor: "#ff6600" }}>
          <Card.Title>
            <h4 style={{ textAlign: "left",fontWeight: "bold",display: "inline" }}>{this.state.movies.title}</h4>
            <h5 style={{ textAlign: "Right",display: "inline",paddingLeft: "40px", fontStyle: "initial",color: "Green" }}>$$</h5>
            <h5 style={{ textAlign: "left" }}>  Bangladeshi,Indian</h5> 
          </Card.Title>
          <Card.Text>
            <span>
              <span style={{ fontWeight: "bold" }}> <MdLocationOn style={{color: "Green"}} /></span> Zindabazar,Sylhet,
              Bangladesh
            </span>
