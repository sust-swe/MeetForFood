# Generated by Django 2.2.7 on 2019-11-14 00:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_bio', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='profiles.Bio')),
                ('user_image', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='profiles.Image')),
